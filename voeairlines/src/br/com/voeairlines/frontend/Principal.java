...
public class Principal {
	...
	public static void main(String[] args) {
		...
		/*
		 * if(idade < 18) {
		 * JOptionPane.showMessageDialog(null,"Embarque Não Autorizado!","VoeAirlines",
		 * JOptionPane.ERROR_MESSAGE); }else { JOptionPane.showMessageDialog(
		 * null,"Boa Viagem! VoeAirlines Alcançando novos voos com você!",
		 * "VoeAirlines", JOptionPane.INFORMATION_MESSAGE);
		 * 
		 * }
		 */
